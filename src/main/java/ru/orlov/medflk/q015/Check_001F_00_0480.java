...
import ru.orlov.medflk.domain.nsi.N008Service;
...
public class Check_001F_00_0480 extends AbstractCheck {

    private final N008Service n008Service;

    @Override
    public String getErrorMessage() {
        return "Код результата диагностики DIAG_RSLT должен быть найден в справочнике N008";
    }
        ...
        return iterateOverOnkSl(zlList, persList, (a, zap, sl, onkSl) -> {
            ...
            if (onkSl.getBdiagList() != null && !onkSl.getBdiagList().isEmpty()) {
                for (Bdiag bdiag : onkSl.getBdiagList()) {
                    ...
                    if (tip == 1 && !n008Service.isValidResOnCodeAndDate(res, code, d2)) {
