...
public class Check_003F_00_1360 extends AbstractCheck {
    ...
    public String getErrorMessage() {
        return "В назначениях код МО NAPR_MO должен отсутствовать при виде назначения не 2 и 3";
    }
    ...
    public List<FlkErr> check(ZlList zlList, PersList persList) {
        return iterateOverSl(zlList, persList, (a, zap, sl) -> {
            ...
            for (Naz naz : sl.getNazList()) {
                ...
                if ((!List.of(2, 3).contains(nazR) || dsOnk == 0) && !isBlank(naprMo)) {
                    return List.of(new FlkErr(zap, sl, null, naprMo));
                }
            }
