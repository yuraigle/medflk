...
@Component
public class Check_002F_00_0580 extends AbstractCheck {

    @Override
    public String getErrorMessage() {
        return "Код результата диагностики DIAG_RSLT должен быть 27 для условий";
    }
        ...
        return iterateOverOnkSl(zlList, persList, (a, zap, sl, onkSl) -> {
            ...
            if (onkSl.getBdiagList() != null) {
                for (Bdiag bdiag : onkSl.getBdiagList()) {
                    ...
                    if (ds13.equals("C34")
                        && onkSlHasRegNum(onkSl, "000074")
                        && Objects.equals(2, bdiag.getDiagTip())
                        && Objects.equals(13, bdiag.getDiagCode())
                        && rslt != 27
                    ) {
