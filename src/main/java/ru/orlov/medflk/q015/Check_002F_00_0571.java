...
@Component
public class Check_002F_00_0571 extends AbstractCheck {

    @Override
    public String getErrorMessage() {
        return "Код результата диагностики DIAG_RSLT должен быть 10 для условий";
    }
        ...
        return iterateOverOnkSl(zlList, persList, (a, zap, sl, onkSl) -> {
            ...
            if (onkSl.getBdiagList() != null) {
                for (Bdiag bdiag : onkSl.getBdiagList()) {
                    ...
                    if (List.of("C18", "C19").contains(ds13)
                        && onkSlHasRegNum(onkSl, "001653")
                        && Objects.equals(2, bdiag.getDiagTip())
                        && Objects.equals(4, bdiag.getDiagCode())
                        && rslt != 10
                    ) {
