...
@Component
public class Check_002F_00_0566 extends AbstractCheck {

    @Override
    public String getErrorMessage() {
        return "Код результата диагностики DIAG_RSLT должен быть 13 для условий";
    }
        ...
        return iterateOverOnkSl(zlList, persList, (a, zap, sl, onkSl) -> {
            ...
            if (onkSl.getBdiagList() != null) {
                for (Bdiag bdiag : onkSl.getBdiagList()) {
                    ...
                    if (ds13.equals("C34")
                        && onkSlHasRegNum(onkSl, "001203")
                        && Objects.equals(2, bdiag.getDiagTip())
                        && Objects.equals(6, bdiag.getDiagCode())
                        && rslt != 13
                    ) {
