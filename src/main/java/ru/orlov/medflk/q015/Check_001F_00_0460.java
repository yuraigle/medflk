...
import ru.orlov.medflk.domain.nsi.N007Service;
...
public class Check_001F_00_0460 extends AbstractCheck {

    private final N007Service n007Service;

    @Override
    public String getErrorMessage() {
        return "Код диагностического показателя DIAG_CODE должен быть найден в справочнике N007";
    }
        ...
        return iterateOverOnkSl(zlList, persList, (a, zap, sl, onkSl) -> {
            ...
            if (onkSl.getBdiagList() != null && !onkSl.getBdiagList().isEmpty()) {
                for (Bdiag bdiag : onkSl.getBdiagList()) {
                    ...
                    if (tip == 1 && !n007Service.isValidCodeOnDate(code, d2)) {
