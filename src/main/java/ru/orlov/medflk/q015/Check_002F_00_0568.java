...
@Component
public class Check_002F_00_0568 extends AbstractCheck {
        ...
        return iterateOverOnkSl(zlList, persList, (a, zap, sl, onkSl) -> {
            ...
            if (onkSl.getBdiagList() != null) {
                for (Bdiag bdiag : onkSl.getBdiagList()) {
                    ...
                    if ((List.of("C25", "C50", "C56", "C57", "C61").contains(ds13) || List.of("C48.0", "C48.1", "C48.2").contains(ds1))
                        && onkSlHasRegNum(onkSl, "001614")
