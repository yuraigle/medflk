...
@Component
public class Check_003F_00_1630 extends AbstractCheck {

    @Override
    public String getErrorMessage() {
        return "Код достоверности DOST должен быть заполнен при отсутствии имени";
    }
    ...
    public List<FlkErr> check(ZlList zlList, PersList persList) {
        return iterateOverZap(zlList, persList, (a, zap) -> {
            ...
            if ("0".equals(novor) && isBlank(pers.getIm()) && !hasDost) {
