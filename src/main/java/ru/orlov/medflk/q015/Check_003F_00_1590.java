...
@Component
public class Check_003F_00_1590 extends AbstractCheck {

    @Override
    public String getErrorMessage() {
        return "Имя представителя должно быть заполнено при NOVOR<>0 и DOST_P<>3";
    }
    ...
    public List<FlkErr> check(ZlList zlList, PersList persList) {
        return iterateOverZap(zlList, persList, (a, zap) -> {
            ...
            if (!"0".equals(novor) && !hasDost3 && isBlank(pers.getImP())) {
