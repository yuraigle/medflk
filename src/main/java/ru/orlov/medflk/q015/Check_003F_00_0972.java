...
public class Check_003F_00_0972 extends AbstractCheck {

    private final M002Service m002Service;

    @Override
    public String getErrorMessage() {
        return "Стадия заболевания STAD должна отсутствовать при диагнозе не из МКБ-О";
    }
