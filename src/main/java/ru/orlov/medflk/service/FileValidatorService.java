...
import ru.orlov.medflk.calc.hospital.HospCalculatorService;
...
public class FileValidatorService {
    ...
    private final HospCalculatorService hospCalculatorService;
    ...
    public FlkP validate(File zip, boolean verbose) {
        ...
        try {
            ...
            hospCalculatorService.calcFile(zlList, persList);
        } catch (Exception e) {
