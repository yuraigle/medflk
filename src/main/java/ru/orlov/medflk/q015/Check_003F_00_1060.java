...
@Component
public class Check_003F_00_1060 extends AbstractCheck {

    @Override
    public String getErrorMessage() {
        return "Кол-во фракций K_FR должно отсутствовать если нет услуг лучевой терапии";
    }
    ...
    public List<FlkErr> check(ZlList zlList, PersList persList) {
        return iterateOverSl(zlList, persList, (a, zap, sl) -> {
            ...
            if (!hasOnkUsl34 && onkSl.getKFr() != null) {
                return List.of(new FlkErr(zap, sl, null, onkSl.getKFr()));
            }
